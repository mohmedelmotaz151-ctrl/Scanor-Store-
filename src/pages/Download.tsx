...
import { Download as DownloadIcon, Smartphone, Apple, CheckCircle2, Zap, ShieldCheck, RefreshCw, SmartphoneIcon } from 'lucide-react';
...
export const Download = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 pt-20 pb-32 overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-96 bg-amber-500/10 blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-4xl mx-auto px-6 relative text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20 text-right" dir="rtl">
          ...
          >
            <div className="absolute top-0 left-0 w-32 h-32 bg-amber-500/5 blur-3xl pointer-events-none"></div>
            <div className="flex items-center gap-4 mb-8">
              <div className="w-14 h-14 bg-amber-500 rounded-2xl flex items-center justify-center shadow-[0_10px_30px_rgba(245,158,11,0.3)]">
                <SmartphoneIcon className="w-8 h-8 text-black" />
              </div>
              <h2 className="text-2xl font-black text-white">تطبيق أندرويد</h2>
            </div>
            ...
            <p className="text-[10px] text-neutral-600 mt-4 text-center">* التثبيت يتم مباشرة عبر المتصفح دون الحاجة لمتجر تطبيقات.</p>
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-neutral-900/50 border border-neutral-800 rounded-[2.5rem] p-10 relative overflow-hidden group"
          >
            <div className="absolute top-0 left-0 w-32 h-32 bg-blue-500/5 blur-3xl pointer-events-none"></div>
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl font-black text-white">آيفون (iOS)</h2>
            </div>
            <p className="text-neutral-500 mb-8 leading-relaxed">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
            <div className="bg-neutral-900/30 p-6 rounded-3xl border border-neutral-800/50 text-center">
            ...
            <div className="bg-neutral-900/30 p-6 rounded-3xl border border-neutral-800/50 text-center">
              <RefreshCw className="w-6 h-6 text-amber-500 mx-auto mb-4" />
